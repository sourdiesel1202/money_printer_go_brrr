...
if __name__ == '__main__':
    ...
    for ticker in module_config['tickers']:
        if module_config['run_concurrently']:
            backtest_ticker_concurrently(["MACD_MACD_CROSS_SIGNAL","DMIPLUS_CROSSOVER_DMINEG","SMA_CONFIRMATION_UPWARD"], ticker, load_backtest_ticker_data(ticker,client, module_config ), module_config)
        else:
