...
if __name__ == '__main__':
    ...
    ticker = "AF"
    # analyze_backtest_results(load_backtest_results(ticker))
    backtest_ticker([AlertType.DMIPLUS_CROSSOVER_DMINEG], ticker, load_backtest_ticker_data(ticker,client, module_config ), module_config)
