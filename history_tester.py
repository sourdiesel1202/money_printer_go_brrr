...
if __name__ == '__main__':
    ...
    for ticker_a in module_config['tickers']:
        ...
        ticker_history_a = load_ticker_history_raw(ticker_a, client, module_config['timespan_multiplier'], module_config['timespan'],get_today(module_config, minus_days=6), get_today(module_config), 50000,module_config)
