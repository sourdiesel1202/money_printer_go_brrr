...
from indicators import load_support_resistance, is_trading_in_sr_band
...
if __name__ == '__main__':
    ...
    for ticker in module_config['tickers']:
        ...
        for i in reversed(range(10, len(_th)-10)):
            ...
            is_trading_in_sr_band(load_support_resistance(ticker, ticker_history, module_config), ticker, ticker_history, module_config)
