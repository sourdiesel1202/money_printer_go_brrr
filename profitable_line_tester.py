...
def compare_tickers_lines_to_market(tickers):
    ...
    for ticker in tickers:
        try:
            ...
            compare_profitable_ticker_lines_to_market(connection,ticker, load_ticker_history_cached(ticker, module_config, connection=connection), module_config, read_only=False)
